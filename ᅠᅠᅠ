...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(0,5,80),
			Second = Color3.fromRGB(0,5,60),
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		NotificationConfig.Image = NotificationConfig.Image or "rbxassetid://17459910236"
		...
		pcall(function()
			if isfile(OrionLib.Folder .. "/" .. game.GameId .. ".txt") then
				...
				OrionLib:MakeNotification({
					Name = "Configuration",
					Content = "Auto-loaded configuration for the game " .. game.GameId .. " " .. "or ".. game.Name,
					Time = 5
				})
			end
		end)		
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "AzureEpic"
	...
	WindowConfig.IntroToggleIcon = WindowConfig.IntroToggleIcon or "rbxassetid://12153971479"
	WindowConfig.IntroText = WindowConfig.IntroText or "skibidi azure welcomes you"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://12153971479"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://12153971479"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			Name = "bye bye",
			Content = "tap the button to reopen",
			Time = 5
		})
	...
	function TabFunction:MakeTab(TabConfig)
		...
		if TabConfig.PremiumOnly then
			...
			SetChildren(SetProps(MakeElement("TFrame"), {
				...
				AddThemeObject(SetProps(MakeElement("Label", "u cant be here vro", 14), {
...
local Configs_HUB = {
	Cor_Hub = Color3.fromRGB(0,5,128),
	Cor_Options = Color3.fromRGB(0,5,128),
